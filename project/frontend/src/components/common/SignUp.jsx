...
const SignUp = () => {
   ...
   return (
      <>
         <Navbar bg="danger" variant="">
            <Container>
               <Navbar.Brand>AdiComplaintCare </Navbar.Brand>
                     ...
                     <div className="card bg-dark text-white">
                        <div className="card-body p-5 text-center">
                           <div className="mb-md-5 mt-md-4 pb-5">
                              <h2 className="fw-bold mb-4 text-info ">SignUp For Registering the Complaint</h2>
                              ...
                              <form onSubmit={handleSubmit}>
                                 ...
                                 <button className="btn btn-outline-warning btn-lg px-5 mt-3" type="submit">Register</button>
                              </form>
                           </div>
                           <div>
